...
exports.createWrappedText = exports.toTitleCase = exports.capitalizeFirst = void 0;
/**
 ...
 */
const createWrappedText = (text, lengthThreshold, 
// istanbul ignore next
hyphenThreshold = defaultHyphenThreshold, 
// istanbul ignore next
delimiter = " ") => {
    const words = text.split(delimiter);
    const hyphenLength = hyphenThreshold > 1 ? hyphenThreshold : Math.floor(lengthThreshold * hyphenThreshold);
    let line = null;
    const result = [];
    for (let index = 0; index < words.length; index++) {
        const word = words[index];
        const lineLength = line?.length ?? 0;
        if ((lineLength === 0 && word.length <= lengthThreshold) ||
...
exports.createWrappedText = createWrappedText;
